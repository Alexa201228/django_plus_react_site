...
export function MentorAddLesson() {
    ...
    const handleSubmit = () => {
        ...
        let lessonName = document.getElementsByName('lessonName')[0].value;
    ...
    const lessonNameChange = (e) => {
        let newLessonName = e.target.value;
    ...
    return (
        <>
            <Container className={'addTestContainer'}>
                <Typography className='introAddTestText'>Добавление урока к курсу Алгоритмы и структуры
                    данных</Typography>
